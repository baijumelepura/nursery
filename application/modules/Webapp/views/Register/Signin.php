...
<style>
 ...
 background-image: linear-gradient(to bottom, rgba(255,255,0,0.5), rgba(0,0,255,0.5)),
  url("https://media.istockphoto.com/photos/back-to-school-with-apple-on-books-and-colorful-pencils-picture-id588609682?k=6&m=588609682&s=612x612&w=0&h=TnLfiTFAwO6COGPxJ3yIhxp7vEyrOXp4Lfk6HqbrJSM=" ) !important ;
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <a href="<?=site_url('register');?>" class="text-center">Register a new nursery</a>
