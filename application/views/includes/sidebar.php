<?php
$ActiveClass = $this->router->fetch_class().'-'.$this->router->fetch_method();
?>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?=config_item('UserData')->user_first_name;?> <?=config_item('UserData')->user_last_name;?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($ActiveClass=='Home-index'){echo 'active';}?>">
